    ...
    >
      <div className="flex flex-col items-center bg-opacity-96 backdrop-opacity-90 backdrop-invert p-6 rounded-3xl md:flex-row md:justify-around lg:w-5/6 lg:justify-around">
        ...
        <div className="lg:ml-10">
          ...
          <h3 className="text-2xl text-gray-600 p-2">Javascript Developer</h3>
          <div className="p-8 w-full flex justify-between">
            ...
            <button className="relative inline-flex items-center justify-center p-0.5 mb-2 mr-2 overflow-hidden text-sm font-medium text-gray-900 rounded-lg group bg-gradient-to-br from-pink-500 to-orange-400 group-hover:from-pink-500 group-hover:to-orange-400 hover:text-white dark:text-white focus:ring-4 focus:ring-pink-200 dark:focus:ring-pink-800">
              <a href="#contact" className="relative px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 rounded-md group-hover:bg-opacity-0">
                Vamos a hablar!
              </a>
            </button>
          </div>
